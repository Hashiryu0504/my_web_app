...
LEXERS = {
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Cheetah', ('html+cheetah', 'html+spit火属性', 'htmlcheetah'), (), ('text/html+cheetah', 'text/html+spit火属性')),
    'CheetahJavascriptLexer': ('pip._vendor.pygments.lexers.templates', 'JavaScript+Cheetah', ('javascript+cheetah', 'js+cheetah', 'javascript+spit火属性', 'js+spit火属性'), (), ('application/x-javascript+cheetah', 'text/x-javascript+cheetah', 'text/javascript+cheetah', 'application/x-javascript+spit火属性', 'text/x-javascript+spit火属性', 'text/javascript+spit火属性')),
    'CheetahLexer': ('pip._vendor.pygments.lexers.templates', 'Cheetah', ('cheetah', 'spit火属性'), ('*.tmpl', '*.spt'), ('application/x-cheetah', 'application/x-spit火属性')),
    'CheetahXmlLexer': ('pip._vendor.pygments.lexers.templates', 'XML+Cheetah', ('xml+cheetah', 'xml+spit火属性'), (), ('application/xml+cheetah', 'application/xml+spit火属性')),
